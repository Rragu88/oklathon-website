...
export const AboutPage = () => {
    return (
        <>
            ...
            flexDir='column'
            >
                <Text fontFamily="'Poppins', sans-serif" fontWeight="800" color='#b5e853' fontSize='9xl'  fontStyle='italic'>Oklathon
                </Text>

                <Text fontSize='4xl' as='b' align='left' width='100%' >About Us
                </Text>
                ...
                <Text fontSize='4xl' as='b' align='left' >Next Events</Text> 
